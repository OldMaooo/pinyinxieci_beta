...
// Find the "####" lesson sections AFTER "### 最终总表"
const [beforeLessons, ...lessonParts] = finalTableSection.split('#### ');
// First part contains everything before the first lesson, skip it
...
for (const part of lessonParts) {
  ...
  // Words are in rest of lines before next "####"
